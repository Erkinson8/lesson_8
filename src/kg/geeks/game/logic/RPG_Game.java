...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(1000, 60, "Kraken");
        ...
        Witcher witcher = new Witcher(280, 0, "Geralt");
        Hacker hacker = new Hacker(270, 5, "Anonymous");

        Hero[] heroes = {warrior1, warrior2, magic, doc, berserk,hacker, assistant, witcher};
